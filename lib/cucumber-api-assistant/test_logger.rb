  ...
  module TestLogger
    ...
    def self.create_logger()
      ...
      if @@loggers.empty?
        ...
        log_to_file = (CucumberApiAssistant::Helpers.get_env("log_to_file") || "true").downcase == true.to_s
        if log_to_file
    ...
    def self.set_log_level()
      log_level = (CucumberApiAssistant::Helpers.get_env("log_level") || "info").downcase
